            ...
            <div class="order-1 col-lg-9 order-lg-last tab-content">
                <div class="tab-pane fade show active" id="dashboard" role="tabpanel">
                    <div class="dashboard-content">
                        <p>
                            Hello <strong
                                class="text-dark">{{ Auth::user()->firstname . ' ' . Auth::user()->lastname }}</strong> (not
                            <strong
                                class="text-dark">{{ Auth::user()->firstname . ' ' . Auth::user()->lastname }}</strong>?)
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($order->deliveryStatus == 'Pending')
                                                    <button onclick="deleteorder(this.id)" class="btn btn-danger btn-sm"
                                                        id="{{ $order->id }}">Cancel</button>
                                                @else
                                                @endif
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Editor" id="acc-name"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ Auth::user()->lastname }}" class="form-control"
                                            id="acc-lastname" name="lastname" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="change-password">
                                ...
                                <div class="form-group">
                                    <label for="acc-password">New Password (leave blank to leave
                                        unchanged)</label>
                                    <input type="password" class="form-control" id="acc-new-password" name="password"
                                        required />
                                </div>
                        ...
                        <form class="mb-2" action="#" method="POST" id="shipaddress">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="firstname"
                                            value="{{ $shipping_address->firstname }}" required />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lastname" value="{{ $shipping_address->lastname }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="street"
                                    placeholder="House number and street name" value="{{ $shipping_address->street }}"
                                    required />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="state" class="form-control"
                                    value="{{ $shipping_address->state }}" required />
                            </div>
