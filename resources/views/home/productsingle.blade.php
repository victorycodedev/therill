        ...
        <div class="product-single-container product-single-default">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 product-single-gallery">
                            ...
                            <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                @foreach ($images as $image)
                                    <div class="product-item">
                                        <img class="product-single-image" src="{{ asset('storage/' . $image->img_file) }}"
                                            data-zoom-image="{{ asset('storage/images/' . $image->img_file) }}"
                            ...
                            <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                <div class="product-item">
                                    <img class="product-single-image"
                                        ...
                                        data-zoom-image="{{ asset('storage/images/' . $product->featured_image) }}"
                                        width="468" height="468" alt="product" />
                                </div>
                            </div>
                        @endif
                    ...
                    @if (count($images) > 0)
                        <div class="prod-thumbnail owl-dots">
                            @foreach ($images as $image)
                                <div class="owl-dot">
                                    <img src="{{ asset('storage/' . $image->img_file) }}" width="110" height="110"
                ...
                <div class="col-lg-7 col-md-6 product-single-details">
                    ...
                    <div class="price-box">
                        <span
                            class="old-price">{{ $settings->currency }}{{ number_format($product->previous_price) }}</span>
                        <span
                            class="new-price">{{ $settings->currency }}{{ number_format($product->current_price) }}</span>
                    </div>
                    <!-- End .price-box -->
                        ...
                        @else
                            <form action="{{ route('user.buyproduct') }}" method="post">
                                ...
                                <div class="product-single-qty">
                                    ...
                                    <input class="" type="hidden" name="amount"
                    ...
                    <!-- End .social-icons --> --}}
                        @auth
                            <a href="javascript:void(0)" class="btn btn-praimry btn-sm add-wishlist"
                                onclick="addtowish(this.id)" id="{{ $product->id }}"><i class="icon-wishlist-2"></i><span>Add
                                    to
                                    Wishlist</span></a>
                        @endauth
                ...
                @foreach ($related as $feat)
                    <div class="product-default">
                        ...
                        <div class="product-details">
                            ...
                            <div class="product-action">
                                <a href="{{ route('productsingle', str_replace(' ', '-', $feat->name)) }}"
                                    class="btn-icon btn-add-cart"><i class="fa fa-arrow-right"></i><span>BUY
                                        NOW</span></a>
                            </div>
                        </div>
                        <!-- End .product-details -->
