                ...
                <div class="p-2 p-md-4 card">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="d-inline">
                                <a href="{{ route('admin.allproducts') }}" class="float-right btn btn-danger btn-sm">Go
                                    Back</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <form action="{{ route('admin.updateproduct') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="mt-2 form-group col-md-6">
                                        ...
                                        <div class="mb-2 input-group mr-sm-2">
                                            ...
                                            <input type="number" name="previous_price" class="form-control"
                                                ...
                                                placeholder="Current Price of item">
                                        </div>
                                    </div>
                                    <div class="mt-2 form-group col-md-6">
                                    ...
                                    <div class="mt-2 form-group col-md-6">
                                        ...
                                        <input type="text" value="{{ $product->instock }}" name="instock"
                                            class="shadow-sm form-control" required>
                                    </div>
                                    <div class="mt-2 form-group col-md-6">
                                    ...
                                    <div class="mt-2 form-group col-md-6">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="imagestat"
                                                value="add" checked>
