                ...
                <div class="p-2 p-md-4 card">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="d-inline">
                                <a href="{{ route('admin.allproducts') }}" class="float-right btn btn-primary btn-sm">My
                                    Products</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <form action="{{ route('admin.saveproduct') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="mt-2 form-group col-md-6">
                                        ...
                                        <input type="text" name="info" class="shadow-sm form-control" required>
                                    ...
                                    <div class="mt-2 form-group col-md-6">
                                        ...
                                        <div class="mb-2 input-group mr-sm-2">
                                            ...
                                            <input type="number" name="current_price" class="form-control"
                                                placeholder="Current Price of item" required>
                                            <small>Eg 20000 NOTE: DO NOT WRITE 20,000, the system will add that for you,
                                                else there will be error.</small>
                                        </div>
                                    </div>
                                    <div class="mt-2 form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="file-upload">
                                            ...
                                            <div class="image-upload-wrap">
                                                <input class="file-upload-input" name="featured_image" type='file'
                                    ...
                                    <div class="form-group col-md-12">
                                        <button type="submit" class="shadow-sm btn btn-primary form-control">Add
                                            Product</button>
                                    </div>
                                </div>
                            </form>
