                        ...
                        <div class="col-md-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Update Advert
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <div class="p-2 p-md-4 card">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-inline">
                                <h3 class="d-inline">Update Advert Info</h3>
                            </div>
                            <div class="d-inline">
                    ...
                    <div class="mt-4 row">
                        <div class="col-md-12">
                          <form action="{{route('admin.updateadvert')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                              <div class="form-row">
                                  ...
                                  <div class="col-md-6">
                                    <img src="{{asset('storage/images/'. $advert->image)}}" alt="" class="w-50">
                                </div>
                                  <input type="hidden" name="id"  value="{{$advert->id}}">
                                  <div class="mt-2 form-group col-md-12">
                                      <label for="">Advert Title<span class="text-danger">*</span></label>
                                      <input type="text" name="title" value="{{$advert->title}}" class="shadow-sm form-control" required>
                                  </div>
                                  ...
                                  <div class="mt-2 form-group col-md-6">
                                      ...
                                      <input type="text" name="whatsapp" value="{{$advert->whatsapp}}" class="shadow-sm form-control" required>
                                  </div>
                                  ...
                                  <div class="mt-2 form-group col-md-12">
                                      ...
                                      <textarea name="description" id="mytextarea" rows="5" class="shadow-sm form-control" required>{{$advert->description}}</textarea>
                                  </div>
                                  <div class="form-group col-md-12">
                                      <button type="submit" class="shadow-sm btn btn-primary form-control">Uodate Advert</button>
                                  </div>
                              </div>       
                          </form>
                        </div>
