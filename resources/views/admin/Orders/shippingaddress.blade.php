                    ...
                    <div class="row">
                        <div class="mt-5 col-md-8 offset-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$addres->company}}" id="" class="shadow form-control" readonly>
                            </div>
                            <div class="form-group">
                                <label for="">Street</label>
                                <input type="text" value="{{$addres->street}}" id="" class="shadow form-control" readonly>
                            </div>
                            <div class="form-group">
                                <label for="">City</label>
                                <input type="text" value="{{$addres->city}}" id="" class="shadow form-control" readonly>
                            </div>
                            <div class="form-group">
                                <label for="">State</label>
                                <input type="text" value="{{$addres->state}}" id="" class="shadow form-control" readonly>
                            </div>
                            <div class="form-group">
                                <label for="">Poster Code</label>
                                <input type="text" value="{{$addres->Postcode}}" id="" class="shadow form-control" readonly>
                            </div>
                            <div class="form-group">
                                <label for="">Phone Number</label>
                                <input type="text" value="{{$user->phone}}" id="" class="shadow form-control" readonly>
                            </div>
                            <div class="form-group">
